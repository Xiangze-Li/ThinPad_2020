...
.HANDLE_BREAK:
    j USERRET_MACHINE
800002d8:	6b00006f          	j	80000988 <USERRET_MACHINE>
...
800005e8:	800002b7          	lui	t0,0x80000
...
.LC0:
    addi t0, t0, -XLEN
80000608:	ffc28293          	addi	t0,t0,-4 # 7ffffffc <KERNEL_STACK_INIT+0xff7ffffc>
    addi sp, sp, -XLEN
...
80000664:	00732023          	sw	t2,0(t1)
    ...
    la t0, PAGE_TABLE
80000668:	00002297          	auipc	t0,0x2
8000066c:	99828293          	addi	t0,t0,-1640 # 80002000 <PAGE_TABLE>
#endif
...
80000670:	00003317          	auipc	t1,0x3
80000674:	99030313          	addi	t1,t1,-1648 # 80003000 <PAGE_TABLE_USER_CODE>
#ifdef RV32
    li t3, 768
80000678:	30000e13          	li	t3,768
#else
    li t3, 512
#endif
    li t2, 0
...
80000680:	20040eb7          	lui	t4,0x20040
80000684:	0fbe8e93          	addi	t4,t4,251 # 200400fb <INITLOCATE-0x5ffbff05>
    slli t5, t2, 10
80000688:	00a39f13          	slli	t5,t2,0xa
    add t4, t4, t5
8000068c:	01ee8eb3          	add	t4,t4,t5
    sw t4, 0(t1)
80000690:	01d32023          	sw	t4,0(t1)
    addi t1, t1, XLEN
80000694:	00430313          	addi	t1,t1,4
    addi t2, t2, 1
80000698:	00138393          	addi	t2,t2,1
    bne t2, t3, .LOOP_USER_CODE
8000069c:	ffc392e3          	bne	t2,t3,80000680 <mtvec_done+0xa4>

    la t1, PAGE_TABLE_USER_CODE
800006a0:	00003317          	auipc	t1,0x3
800006a4:	96030313          	addi	t1,t1,-1696 # 80003000 <PAGE_TABLE_USER_CODE>
    srli t1, t1, 2
800006a8:	00235313          	srli	t1,t1,0x2
    ori t1, t1, 0xf1
800006ac:	0f136313          	ori	t1,t1,241
    sw t1, 0(t0)
800006b0:	0062a023          	sw	t1,0(t0)
    sw t1, 8(t0)
#endif
    ...
    la t0, PAGE_TABLE
800006b4:	00002297          	auipc	t0,0x2
800006b8:	94c28293          	addi	t0,t0,-1716 # 80002000 <PAGE_TABLE>
    la t1, PAGE_TABLE_KERNEL_CODE
800006bc:	00004317          	auipc	t1,0x4
800006c0:	94430313          	addi	t1,t1,-1724 # 80004000 <PAGE_TABLE_KERNEL_CODE>
    srli t1, t1, 2
800006c4:	00235313          	srli	t1,t1,0x2
    ori t1, t1, 0xf1
800006c8:	0f136313          	ori	t1,t1,241
#ifdef RV32
    li t2, 512*4
800006cc:	000013b7          	lui	t2,0x1
800006d0:	80038393          	addi	t2,t2,-2048 # 800 <INITLOCATE-0x7ffff800>
#else
    li t2, 2*8
#endif
    add t2, t0, t2
800006d4:	007283b3          	add	t2,t0,t2
    sw t1, 0(t2)
800006d8:	0063a023          	sw	t1,0(t2)
...
800006dc:	00005317          	auipc	t1,0x5
800006e0:	92430313          	addi	t1,t1,-1756 # 80005000 <PAGE_TABLE_USER_STACK>
    addi t1, t1, 4*16
800006e4:	04030313          	addi	t1,t1,64
    li t3, 1024
800006e8:	40000e13          	li	t3,1024
    li t2, 16
800006ec:	01000393          	li	t2,16
.LOOP_USER_STACK:
    li t4, 0x200fc0f7  // 0x803F0000 DAGU-WRV
800006f0:	200fceb7          	lui	t4,0x200fc
800006f4:	0f7e8e93          	addi	t4,t4,247 # 200fc0f7 <INITLOCATE-0x5ff03f09>
    slli t5, t2, 10
800006f8:	00a39f13          	slli	t5,t2,0xa
    add t4, t4, t5
800006fc:	01ee8eb3          	add	t4,t4,t5
    sw t4, 0(t1)
80000700:	01d32023          	sw	t4,0(t1)
    addi t1, t1, 4
80000704:	00430313          	addi	t1,t1,4
    addi t2, t2, 1
80000708:	00138393          	addi	t2,t2,1
    bne t2, t3, .LOOP_USER_STACK
8000070c:	ffc392e3          	bne	t2,t3,800006f0 <mtvec_done+0x114>

    la t1, PAGE_TABLE_USER_STACK
80000710:	00005317          	auipc	t1,0x5
80000714:	8f030313          	addi	t1,t1,-1808 # 80005000 <PAGE_TABLE_USER_STACK>
    srli t1, t1, 2
80000718:	00235313          	srli	t1,t1,0x2
    ori t1, t1, 0xf1
8000071c:	0f136313          	ori	t1,t1,241
    li t2, 2044
80000720:	7fc00393          	li	t2,2044
    add t2, t0, t2
80000724:	007283b3          	add	t2,t0,t2
    sw t1, 0(t2)
80000728:	0063a023          	sw	t1,0(t2)
    li t2, 8
    add t2, t0, t2
    sw t1, 0(t2)
#endif
    ...
    la t0, PAGE_TABLE
8000072c:	00002297          	auipc	t0,0x2
80000730:	8d428293          	addi	t0,t0,-1836 # 80002000 <PAGE_TABLE>
    srli t0, t0, 12
80000734:	00c2d293          	srli	t0,t0,0xc
#ifdef RV32
    li t1, SATP_SV32
80000738:	80000337          	lui	t1,0x80000
#else
    li t1, SATP_SV39
#endif
    or t0, t0, t1
8000073c:	0062e2b3          	or	t0,t0,t1
    csrw satp, t0
80000740:	18029073          	csrw	satp,t0
    sfence.vma
80000744:	12000073          	sfence.vma
#endif

    j WELCOME                       // 进入主线程
80000748:	0040006f          	j	8000074c <WELCOME>

8000074c <WELCOME>:

WELCOME:
    la s1, monitor_version          // 装入启动信息
8000074c:	00001497          	auipc	s1,0x1
80000750:	a2048493          	addi	s1,s1,-1504 # 8000116c <monitor_version>
    lb a0, 0(s1)
80000754:	00048503          	lb	a0,0(s1)
.Loop0:
    addi s1, s1, 0x1
80000758:	00148493          	addi	s1,s1,1
    jal WRITE_SERIAL                // 调用串口写函数
8000075c:	8b1ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
    lb a0, 0(s1)
80000760:	00048503          	lb	a0,0(s1)
    bne a0, zero, .Loop0            // 打印循环至0结束符
80000764:	fe051ae3          	bnez	a0,80000758 <WELCOME+0xc>

    j SHELL                         // 开始交互
80000768:	0340006f          	j	8000079c <SHELL>
...
80000790:	00000013          	nop
    j IDLELOOP
80000794:	fd9ff06f          	j	8000076c <IDLELOOP>
    nop
...
8000079c:	8f5ff0ef          	jal	ra,80000090 <READ_SERIAL>

    ori t0, zero, 'R'
800007a0:	05206293          	ori	t0,zero,82
    beq a0, t0, .OP_R
800007a4:	06550a63          	beq	a0,t0,80000818 <.OP_R>
    ori t0, zero, 'D'
800007a8:	04406293          	ori	t0,zero,68
    beq a0, t0, .OP_D
800007ac:	0a550463          	beq	a0,t0,80000854 <.OP_D>
    ori t0, zero, 'A'
800007b0:	04106293          	ori	t0,zero,65
    beq a0, t0, .OP_A
800007b4:	0e550063          	beq	a0,t0,80000894 <.OP_A>
    ori t0, zero, 'G'
800007b8:	04706293          	ori	t0,zero,71
    beq a0, t0, .OP_G
800007bc:	10550e63          	beq	a0,t0,800008d8 <.OP_G>
    ori t0, zero, 'T'
800007c0:	05406293          	ori	t0,zero,84
    beq a0, t0, .OP_T
800007c4:	00550863          	beq	a0,t0,800007d4 <.OP_T>

    li a0, XLEN                     // 错误的操作符，输出 XLEN，用于区分 RV32 和 RV64
800007c8:	00400513          	li	a0,4
    jal WRITE_SERIAL                 // 把 XLEN 写给 term
800007cc:	841ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
    j .DONE                         
800007d0:	2940006f          	j	80000a64 <.DONE>

800007d4 <.OP_T>:

.OP_T:                              // 操作 - 打印页表
    addi sp, sp, -3*XLEN
800007d4:	ff410113          	addi	sp,sp,-12
    STORE s1, 0(sp)
800007d8:	00912023          	sw	s1,0(sp)
    STORE s2, XLEN(sp)
800007dc:	01212223          	sw	s2,4(sp)

#ifdef ENABLE_PAGING
    csrr s1, satp
800007e0:	180024f3          	csrr	s1,satp
    slli s1, s1, 12
800007e4:	00c49493          	slli	s1,s1,0xc
#else
    li s1, -1
#endif
    STORE s1, 2*XLEN(sp)
800007e8:	00912423          	sw	s1,8(sp)
    addi s1, sp, 2*XLEN
800007ec:	00810493          	addi	s1,sp,8
    li s2, XLEN
800007f0:	00400913          	li	s2,4
.LC0:
    lb a0, 0(s1)           // 读取字节
800007f4:	00048503          	lb	a0,0(s1)
    addi s2, s2, -1                 // 滚动计数器
800007f8:	fff90913          	addi	s2,s2,-1
    jal WRITE_SERIAL                 // 写入串口
800007fc:	811ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
    addi s1, s1, 0x1                // 移动打印指针
80000800:	00148493          	addi	s1,s1,1
    bne s2, zero, .LC0              // 打印循环
80000804:	fe0918e3          	bnez	s2,800007f4 <.OP_T+0x20>

    LOAD s1, 0x0(sp)
80000808:	00012483          	lw	s1,0(sp)
    LOAD s2, XLEN(sp)
8000080c:	00412903          	lw	s2,4(sp)
    addi sp, sp, 3*XLEN
80000810:	00c10113          	addi	sp,sp,12

    j .DONE
80000814:	2500006f          	j	80000a64 <.DONE>

80000818 <.OP_R>:

.OP_R:                              // 操作 - 打印用户空间寄存器
    addi sp, sp, -2*XLEN                 // 保存s1,s2
80000818:	ff810113          	addi	sp,sp,-8
    STORE s1, 0(sp)
8000081c:	00912023          	sw	s1,0(sp)
    STORE s2, XLEN(sp)
80000820:	01212223          	sw	s2,4(sp)

    la s1, uregs
80000824:	007ef497          	auipc	s1,0x7ef
80000828:	7dc48493          	addi	s1,s1,2012 # 807f0000 <_sbss>
    ori s2, zero, 31*XLEN               // 计数器，打印 31 个寄存器
8000082c:	07c06913          	ori	s2,zero,124
.LC1:
    lb a0, 0(s1)           // 读取字节
80000830:	00048503          	lb	a0,0(s1)
    addi s2, s2, -1                 // 滚动计数器
80000834:	fff90913          	addi	s2,s2,-1
    jal WRITE_SERIAL                 // 写入串口
80000838:	fd4ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
    addi s1, s1, 0x1                // 移动打印指针
8000083c:	00148493          	addi	s1,s1,1
    bne s2, zero, .LC1              // 打印循环
80000840:	fe0918e3          	bnez	s2,80000830 <.OP_R+0x18>

    LOAD s1, 0(sp)                    // 恢复s1,s2
80000844:	00012483          	lw	s1,0(sp)
    LOAD s2, XLEN(sp)
80000848:	00412903          	lw	s2,4(sp)
    addi sp, sp, 2*XLEN
8000084c:	00810113          	addi	sp,sp,8
    j .DONE
80000850:	2140006f          	j	80000a64 <.DONE>

80000854 <.OP_D>:

.OP_D:                              // 操作 - 打印内存num字节
    addi sp, sp, -2*XLEN                 // 保存s1,s2
80000854:	ff810113          	addi	sp,sp,-8
    STORE s1, 0(sp)
80000858:	00912023          	sw	s1,0(sp)
    STORE s2, XLEN(sp)
8000085c:	01212223          	sw	s2,4(sp)

    jal READ_SERIAL_XLEN
80000860:	8cdff0ef          	jal	ra,8000012c <READ_SERIAL_XLEN>
    or s1, a0, zero                 // 获得addr
80000864:	000564b3          	or	s1,a0,zero
    jal READ_SERIAL_XLEN
80000868:	8c5ff0ef          	jal	ra,8000012c <READ_SERIAL_XLEN>
    or s2, a0, zero                 // 获得num
8000086c:	00056933          	or	s2,a0,zero

.LC2:
    lb a0, 0(s1)                    // 读取字节
80000870:	00048503          	lb	a0,0(s1)
    addi s2, s2, -1                 // 滚动计数器
80000874:	fff90913          	addi	s2,s2,-1
    jal WRITE_SERIAL                 // 写入串口
80000878:	f94ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
    addi s1, s1, 0x1                // 移动打印指针
8000087c:	00148493          	addi	s1,s1,1
    bne s2, zero, .LC2              // 打印循环
80000880:	fe0918e3          	bnez	s2,80000870 <.OP_D+0x1c>

    LOAD s1, 0(sp)                    // 恢复s1,s2
80000884:	00012483          	lw	s1,0(sp)
    LOAD s2, XLEN(sp)
80000888:	00412903          	lw	s2,4(sp)
    addi sp, sp, 2*XLEN
8000088c:	00810113          	addi	sp,sp,8
    j .DONE
80000890:	1d40006f          	j	80000a64 <.DONE>

80000894 <.OP_A>:

.OP_A:                              // 操作 - 写入内存num字节，num为4的倍数
    addi sp, sp, -2*XLEN                 // 保存s1,s2
80000894:	ff810113          	addi	sp,sp,-8
    STORE s1, 0(sp)
80000898:	00912023          	sw	s1,0(sp)
    STORE s2, 4(sp)
8000089c:	01212223          	sw	s2,4(sp)

    jal READ_SERIAL_XLEN
800008a0:	88dff0ef          	jal	ra,8000012c <READ_SERIAL_XLEN>
    or s1, a0, zero                 // 获得addr
800008a4:	000564b3          	or	s1,a0,zero
    jal READ_SERIAL_XLEN
800008a8:	885ff0ef          	jal	ra,8000012c <READ_SERIAL_XLEN>
    or s2, a0, zero                 // 获得num
800008ac:	00056933          	or	s2,a0,zero
    srl s2, s2, 2                   // num除4，获得字数
800008b0:	00295913          	srli	s2,s2,0x2
.LC3:                               // 每次写入一字
    jal READ_SERIAL_WORD              // 从串口读入一字
800008b4:	ff8ff0ef          	jal	ra,800000ac <READ_SERIAL_WORD>
    sw a0, 0(s1)                    // 写内存一字
800008b8:	00a4a023          	sw	a0,0(s1)
    addi s2, s2, -1                 // 滚动计数器
800008bc:	fff90913          	addi	s2,s2,-1
    addi s1, s1, 4                  // 移动写指针
800008c0:	00448493          	addi	s1,s1,4
    bne s2, zero, .LC3              // 写循环
800008c4:	fe0918e3          	bnez	s2,800008b4 <.OP_A+0x20>
    ...
    LOAD s1, 0(sp)                    // 恢复s1,s2
800008c8:	00012483          	lw	s1,0(sp)
    LOAD s2, XLEN(sp)
800008cc:	00412903          	lw	s2,4(sp)
    addi sp, sp, 2*XLEN
800008d0:	00810113          	addi	sp,sp,8
    j .DONE
800008d4:	1900006f          	j	80000a64 <.DONE>

800008d8 <.OP_G>:

.OP_G:
    jal READ_SERIAL_XLEN            // 获取addr
800008d8:	855ff0ef          	jal	ra,8000012c <READ_SERIAL_XLEN>
    mv s10, a0                      // 保存到 s10
800008dc:	00050d13          	mv	s10,a0

    ori a0, zero, TIMERSET          // 写TIMERSET(0x06)信号
800008e0:	00606513          	ori	a0,zero,6
    jal WRITE_SERIAL                 // 告诉终端用户程序开始运行
800008e4:	f28ff0ef          	jal	ra,8000000c <WRITE_SERIAL>

#ifdef ENABLE_INT
    csrw mepc, s10                // 用户程序入口写入EPC
800008e8:	341d1073          	csrw	mepc,s10
    li a0, MSTATUS_MPP_MASK
800008ec:	00002537          	lui	a0,0x2
800008f0:	80050513          	addi	a0,a0,-2048 # 1800 <INITLOCATE-0x7fffe800>
    csrc mstatus, a0     // 设置 MPP=0 ，对应 U-mode
800008f4:	30053073          	csrc	mstatus,a0
#endif

    la ra, uregs              // 定位用户空间寄存器备份地址
800008f8:	007ef097          	auipc	ra,0x7ef
800008fc:	70808093          	addi	ra,ra,1800 # 807f0000 <_sbss>
    STORE sp, TF_ksp(ra)           // 保存栈指针
80000900:	0820a023          	sw	sp,128(ra)

    // LOAD x1,  TF_ra(ra)
    LOAD sp, TF_sp(ra)
80000904:	0040a103          	lw	sp,4(ra)
    LOAD gp, TF_gp(ra)
80000908:	0080a183          	lw	gp,8(ra)
    LOAD tp, TF_tp(ra)
8000090c:	00c0a203          	lw	tp,12(ra)
    LOAD t0, TF_t0(ra)
80000910:	0100a283          	lw	t0,16(ra)
    LOAD t1, TF_t1(ra)
80000914:	0140a303          	lw	t1,20(ra)
    LOAD t2, TF_t2(ra)
80000918:	0180a383          	lw	t2,24(ra)
    LOAD s0, TF_s0(ra)
8000091c:	01c0a403          	lw	s0,28(ra)
    LOAD s1, TF_s1(ra)
80000920:	0200a483          	lw	s1,32(ra)
    LOAD a0, TF_a0(ra)
80000924:	0240a503          	lw	a0,36(ra)
    LOAD a1, TF_a1(ra)
80000928:	0280a583          	lw	a1,40(ra)
    LOAD a2, TF_a2(ra)
8000092c:	02c0a603          	lw	a2,44(ra)
    LOAD a3, TF_a3(ra)
80000930:	0300a683          	lw	a3,48(ra)
    LOAD a4, TF_a4(ra)
80000934:	0340a703          	lw	a4,52(ra)
    LOAD a5, TF_a5(ra)
80000938:	0380a783          	lw	a5,56(ra)
    LOAD a6, TF_a6(ra)
8000093c:	03c0a803          	lw	a6,60(ra)
    LOAD a7, TF_a7(ra)
80000940:	0400a883          	lw	a7,64(ra)
    LOAD s2, TF_s2(ra)
80000944:	0440a903          	lw	s2,68(ra)
    LOAD s3, TF_s3(ra)
80000948:	0480a983          	lw	s3,72(ra)
    LOAD s4, TF_s4(ra)
8000094c:	04c0aa03          	lw	s4,76(ra)
    LOAD s5, TF_s5(ra)
80000950:	0500aa83          	lw	s5,80(ra)
    LOAD s6, TF_s6(ra)
80000954:	0540ab03          	lw	s6,84(ra)
    LOAD s7, TF_s7(ra)
80000958:	0580ab83          	lw	s7,88(ra)
    LOAD s8, TF_s8(ra)
8000095c:	05c0ac03          	lw	s8,92(ra)
    LOAD s9, TF_s9(ra)
80000960:	0600ac83          	lw	s9,96(ra)
    // LOAD s10, TF_s10(ra)
    LOAD s11, TF_s11(ra)
80000964:	0680ad83          	lw	s11,104(ra)
    LOAD t3, TF_t3(ra)
80000968:	06c0ae03          	lw	t3,108(ra)
    LOAD t4, TF_t4(ra)
8000096c:	0700ae83          	lw	t4,112(ra)
    LOAD t5, TF_t5(ra)
80000970:	0740af03          	lw	t5,116(ra)
    LOAD t6, TF_t6(ra)
80000974:	0780af83          	lw	t6,120(ra)
...
8000097c:	00c08093          	addi	ra,ra,12 # 80000984 <.USERRET_USER>
    mret                                // 进入用户程序
80000980:	30200073          	mret

80000984 <.USERRET_USER>:
    jr s10
#endif
...
.USERRET_USER:
    ebreak
80000984:	00100073          	ebreak

80000988 <USERRET_MACHINE>:

    .global USERRET_MACHINE
USERRET_MACHINE:
    la s1, uregs
80000988:	007ef497          	auipc	s1,0x7ef
8000098c:	67848493          	addi	s1,s1,1656 # 807f0000 <_sbss>
    li s2, TF_SIZE                  // 计数器
80000990:	08000913          	li	s2,128
.LC4:
    lw a0, 0(sp)
80000994:	00012503          	lw	a0,0(sp)
    sw a0, 0(s1)
80000998:	00a4a023          	sw	a0,0(s1)
    addi s2, s2, -4                 // 滚动计数器
8000099c:	ffc90913          	addi	s2,s2,-4
    addi s1, s1, 0x4
800009a0:	00448493          	addi	s1,s1,4
    addi sp, sp, 0x4
800009a4:	00410113          	addi	sp,sp,4
    bne s2, zero, .LC4
800009a8:	fe0916e3          	bnez	s2,80000994 <USERRET_MACHINE+0xc>

    la s1, uregs
800009ac:	007ef497          	auipc	s1,0x7ef
800009b0:	65448493          	addi	s1,s1,1620 # 807f0000 <_sbss>
    LOAD sp, TF_ksp(s1)             // 重新获得当前监控程序栈顶指针
800009b4:	0804a103          	lw	sp,128(s1)

    ori a0, zero, TIMETOKEN         // 发送TIMETOKEN(0x07)信号
800009b8:	00706513          	ori	a0,zero,7
    jal WRITE_SERIAL                // 告诉终端用户程序结束运行
800009bc:	e50ff0ef          	jal	ra,8000000c <WRITE_SERIAL>

    j .DONE
800009c0:	0a40006f          	j	80000a64 <.DONE>
...
.USERRET2:
    la ra, uregs              // 定位用户空间寄存器备份地址
800009c4:	007ef097          	auipc	ra,0x7ef
800009c8:	63c08093          	addi	ra,ra,1596 # 807f0000 <_sbss>

    //STORE ra, TF_ra(ra)
    STORE sp, TF_sp(ra)
800009cc:	0020a223          	sw	sp,4(ra)
    STORE gp, TF_gp(ra)
800009d0:	0030a423          	sw	gp,8(ra)
    STORE tp, TF_tp(ra)
800009d4:	0040a623          	sw	tp,12(ra)
    STORE t0, TF_t0(ra)
800009d8:	0050a823          	sw	t0,16(ra)
    STORE t1, TF_t1(ra)
800009dc:	0060aa23          	sw	t1,20(ra)
    STORE t2, TF_t2(ra)
800009e0:	0070ac23          	sw	t2,24(ra)
    STORE s0, TF_s0(ra)
800009e4:	0080ae23          	sw	s0,28(ra)
    STORE s1, TF_s1(ra)
800009e8:	0290a023          	sw	s1,32(ra)
    STORE a0, TF_a0(ra)
800009ec:	02a0a223          	sw	a0,36(ra)
    STORE a1, TF_a1(ra)
800009f0:	02b0a423          	sw	a1,40(ra)
    STORE a2, TF_a2(ra)
800009f4:	02c0a623          	sw	a2,44(ra)
    STORE a3, TF_a3(ra)
800009f8:	02d0a823          	sw	a3,48(ra)
    STORE a4, TF_a4(ra)
800009fc:	02e0aa23          	sw	a4,52(ra)
    STORE a5, TF_a5(ra)
80000a00:	02f0ac23          	sw	a5,56(ra)
    STORE a6, TF_a6(ra)
80000a04:	0300ae23          	sw	a6,60(ra)
    STORE a7, TF_a7(ra)
80000a08:	0510a023          	sw	a7,64(ra)
    STORE s2, TF_s2(ra)
80000a0c:	0520a223          	sw	s2,68(ra)
    STORE s3, TF_s3(ra)
80000a10:	0530a423          	sw	s3,72(ra)
    STORE s4, TF_s4(ra)
80000a14:	0540a623          	sw	s4,76(ra)
    STORE s5, TF_s5(ra)
80000a18:	0550a823          	sw	s5,80(ra)
    STORE s6, TF_s6(ra)
80000a1c:	0560aa23          	sw	s6,84(ra)
    STORE s7, TF_s7(ra)
80000a20:	0570ac23          	sw	s7,88(ra)
    STORE s8, TF_s8(ra)
80000a24:	0580ae23          	sw	s8,92(ra)
    STORE s9, TF_s9(ra)
80000a28:	0790a023          	sw	s9,96(ra)
    STORE s10, TF_s10(ra)
80000a2c:	07a0a223          	sw	s10,100(ra)
    STORE s11, TF_s11(ra)
80000a30:	07b0a423          	sw	s11,104(ra)
    STORE t3, TF_t3(ra)
80000a34:	07c0a623          	sw	t3,108(ra)
    STORE t4, TF_t4(ra)
80000a38:	07d0a823          	sw	t4,112(ra)
    STORE t5, TF_t5(ra)
80000a3c:	07e0aa23          	sw	t5,116(ra)
    STORE t6, TF_t6(ra)
80000a40:	07f0ac23          	sw	t6,120(ra)

    LOAD sp, TF_ksp(ra)             // 重新获得当前监控程序栈顶指针
80000a44:	0800a103          	lw	sp,128(ra)
    mv a0, ra
80000a48:	00008513          	mv	a0,ra
    la ra, .USERRET2
80000a4c:	00000097          	auipc	ra,0x0
80000a50:	f7808093          	addi	ra,ra,-136 # 800009c4 <.USERRET2>
    STORE ra, TF_ra(a0)
80000a54:	00152023          	sw	ra,0(a0)

    ori a0, zero, TIMETOKEN         // 发送TIMETOKEN(0x07)信号
80000a58:	00706513          	ori	a0,zero,7
    jal WRITE_SERIAL                // 告诉终端用户程序结束运行
80000a5c:	db0ff0ef          	jal	ra,8000000c <WRITE_SERIAL>

    j .DONE
80000a60:	0040006f          	j	80000a64 <.DONE>

80000a64 <.DONE>:

.DONE:
    j SHELL                         // 交互循环
80000a64:	d39ff06f          	j	8000079c <SHELL>
	...
